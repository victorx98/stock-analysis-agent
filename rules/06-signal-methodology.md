...
The purpose of the signal is to support money-making research decisions, not to produce a balanced essay. Start by asking: "Where is the asymmetric opportunity or capital-protection problem?"
...
- `Bottom line`: one or two plain-English sentences stating whether the stock looks attractive, unattractive, or worth waiting on.
